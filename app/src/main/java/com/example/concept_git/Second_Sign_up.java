...
import com.example.concept_git.mail.JavaMailAPI;
...
public class Second_Sign_up extends AppCompatActivity {
    ...
    String URL = "http://10.0.2.2:8244/PROJECT2020/aayesha.asmx/AddNewUser";
    ...
    public void sendMail() {
        ...
        String message = "Your UserId is " + name;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        Toast.makeText(Second_Sign_up.this, " Exception =" + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
